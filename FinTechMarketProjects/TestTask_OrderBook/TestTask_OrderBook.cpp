/**============================================================================
Name        : TestTask_OrderBook.h
Created on  : 30.04.2023
Author      : Tokmakov Andrei
Version     : 1.0
Copyright   : Your copyright notice
Description : TestTask_OrderBook
============================================================================**/

#include "TestTask_OrderBook.h"
...
namespace TestTask_OrderBook::Tests
{
    static constexpr std::string_view dataFilePath {R"(../../FinTechMarketProjects/data/orders2.dat)" };
...
void TestTask_OrderBook::TestAll()
{
