...
namespace TreatmentPlan {
    ...
    struct ToothModellingData {
        Axes axes { };
        Origin origin { Point3d::Zero() };
        Quaternion quaternion {0, 0, 0, 0};
        Point3d anchor_point_1 { Point3d::Zero() };
        Point3d anchor_point_2 { Point3d::Zero() };
        Point3d anchor_point_3 { Point3d::Zero() };
        Point3d anchor_point_local_1 { Point3d::Zero() };
        Point3d anchor_point_local_2 { Point3d::Zero() };
        Point3d anchor_point_local_3 { Point3d::Zero() };
    };

    struct ToothFrame {
        std::vector<Quaternion> quaternions;
        Point3d translation { Point3d::Zero() };
