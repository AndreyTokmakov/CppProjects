...
namespace MemoryUsageTest
{
    ...
    void Test()
    {
        ...
        {
            std::vector<std::string> buffer(1'000'000);
         ...
         [[maybe_unused]] char** argv)
{
    ...
    // MemoryUsageTest::Test();

    // std::cout << min_refills(10, 20, 4, {13,17,18,22 , 30}) << std::endl;
    //std::cout << min_refills(10, 25, 5, {13,17,18,21,22 , 30}) << std::endl;

    average_prices({
        {"new 1 IBM buy 20 200"},
        {"fill 1 5 100.00"},
        {"fill 1 10 130.00"},
        {"fill 1 5 150.00"}});
