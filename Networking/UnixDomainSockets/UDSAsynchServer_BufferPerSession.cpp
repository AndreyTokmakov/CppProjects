/**============================================================================
Name        : UDSAsynchServer_BufferPerSession.cpp
Created on  : 31.03.2025
Author      : Andrei Tokmakov
Version     : 1.0
Copyright   : Your copyright notice
Description : UDSAsynchServer_BufferPerSession.cpp
============================================================================**/
...
namespace UDSAsynchServer_BufferPerSession
{
    struct UDSServer
    {
            ...
            for (uint32_t idx = 0; idx < currentSize; idx++)
            {
                ...
                else
                {
                    ...
                    while (true)
                    {
                        ...
                        buffer.validateAvailableSize(maxReceiveSize);
                        const int64_t bytesRead = ::recv(clientSocket,buffer.tail(), maxReceiveSize, 0);
...
void UDSAsynchServer::runServer_BufferPerSession()
{
    using namespace UDSAsynchServer_BufferPerSession;
