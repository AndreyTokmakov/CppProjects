//
// Created by andtokm on 12/27/25.
//

#ifndef CPPPROJECTS_MPSC_QUEUE_H
#define CPPPROJECTS_MPSC_QUEUE_H
...
template <typename T>
concept QueueableT = std::default_initializable<T> && std::move_constructible<T>;

/**
 * @brief The `mpsc_queue` class provides a single-reader, multi-writer
 * fifo queue.
 */
template <QueueableT T, std::size_t N>
class mpsc_queue
{
private:
...
#endif //CPPPROJECTS_MPSC_QUEUE_H