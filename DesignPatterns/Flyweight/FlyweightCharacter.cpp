...
namespace
{
    ...
    {
        ConcreteCharacter(const char aSymbol, const int aPointSize)
        {
            mSymbol = aSymbol;
            mWidth = 120;
            mHeight = 100;
...
void flyweight::character::Test()
{
    const std::string document = "AAZZBBZB";
    CharacterFactory<12> characterFactory;
    for (const auto it : document) {
