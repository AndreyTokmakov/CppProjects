/**============================================================================
Name        : CommandBusHandler.cpp
Created on  : 01.08.2026
Author      : Andrei Tokmakov
Version     : 1.0
Copyright   : Your copyright notice
Description : CommandBusHandler.cpp
============================================================================**/
...
namespace
{
    ...
    public:
        ...
        explicit CreateUserHandler(UserRepository& repository) noexcept : repository(repository){
        }
    ...
    public:
        ...
        explicit DeleteUserHandler(UserRepository& repository) noexcept : repository(repository){
        }
    ...
    public:
        ...
        explicit RenameUserHandler(UserRepository& repository) noexcept: repository(repository) {
        }
...
void command::command_bus_handler::TestAll()
{
    UserRepository repository;
